<?php
/**
 * This file is part of CRS-Tools.
 *
 ...
 * @link      https://github.com/crs-tools
 */
...
// create client
$client = new \C3TT\Client('https://tracker.url/rpc', $token, $secret);
...
try {
	...
	$child_ticket = $client->createEncodingTicket($ticket['id'], $profiles[0]['encoding_profile_id'], ['Encoding.Test' => 42]);
